...
<div ALIGN="center">
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1">
		...
		<tr>
			<td><img src="${pageContext.request.contextPath}/images/right.jpg" height="100%" width="100%"></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <td class="login_msg" width="400">
				<s:form action="StaffAction_login">
					...
					<br/>
					用户名：<s:textfield name="loginName" class="msg"></s:textfield><br/><br/>
					密&nbsp;码：<s:password name="loginPwd" class="msg"></s:password><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
