				...
				<table border="0" width="145" id="table7" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="150" height="35"><p align="right">
							<font color="#FFFFFF">欢迎您：${sessionScope.staff1.staffName}<b></b>
							</font>
						</td>
					</tr>
				</table>
						...
						<div align="right">
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									...
									<td width="55" valign="middle"><a href="${pageContext.request.contextPath}/StaffAction_loginout" target="_top"><font color="ffffff">重新登录</font></a></td>
								</tr>
							</table>
						</div>
						</td>
